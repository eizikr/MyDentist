        ...
        builder: (((context, snapshot) {
          if (snapshot.connectionState == ConnectionState.done) {
            ...
            return SingleChildScrollView(
                    child: Expanded(
                      child: Padding(
                        padding: const EdgeInsets.fromLTRB(180.0,75.0,180.0,75.0),
                        child: Column(children: [
                          const SizedBox(height: 10),
                          _TextFormField(
                            title: "First name: ${crypto.decryptAES(data['first_name'])}",
                          ...
                          const SizedBox(height: 10),
                          _TextFormField(
                            title: "Last name: ${crypto.decryptAES(data['last_name'])}",
                          ...
                          const SizedBox(height: 10),
                          _TextFormField(
                            title: "Father's Name: ${crypto.decryptAES(data['fathers_name'])}",
                          ...
                          const SizedBox(height: 10),
                          _TextFormField(
                            title: 'Treating Doctor: ${crypto.decryptAES(data['treating_docrot'])}',
                          ...
                          const SizedBox(height: 10),
                          _TextFormField(
                            title: 'Home Phone: ${crypto.decryptAES(data['home_phone'])}',
                          ...
                          const SizedBox(height: 10),
                          _TextFormField(
                            title: 'Insurance Company: ${crypto.decryptAES(data['inisurance_company'])}',
